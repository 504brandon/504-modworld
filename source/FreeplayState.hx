...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (openfl.Assets.exists(Paths.txt('data/freeplaySongList ${MainMenuState.mod}')))
			initSonglist = CoolUtil.coolTextFile(Paths.txt('data/freeplaySongList ${MainMenuState.mod}'));
		else
			initSonglist = CoolUtil.coolTextFile(Paths.txt('data/freeplaySongList'));

		trace(Paths.txt('data/freeplaySongList ${MainMenuState.mod}'));
